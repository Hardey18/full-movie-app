...
function RecentlyAdded({ simplified }: any) {
    const [realBoxOffice, setRealBoxOffice] = useState([]);

    const { data: getBoxOffice } = useGetRecentlyAddedQuery({
